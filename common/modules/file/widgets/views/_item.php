...
?>
<div class="filemanager-item <?= $model->isImage ? 'filemanager-item-image' : '' ?>" data-id="<?= $model->file_id ?>" data-image="<?= $model->getSrc('small') ?>" data-isImage="<?= $model->getIsImage() ?>" data-title="<?= Html::encode(strip_tags($model->title)) ?>">
