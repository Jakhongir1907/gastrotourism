...
namespace common\modules\restaurant\behaviors;
...
/**
 * Class RestaurantFoodsBehavior
 *
 * @package common\modules\restaurant
 */
class RestaurantFoodsBehavior extends AttributeBehavior
{
	/**
	 * @var string
	 */
	public $attribute = "restaurant_foods_data";
	/**
	 * @var string
	 */
	public $relation_name = "restaurantFoods";
	/**
	 * @var string
	 */
	public $delimitr = ",";
	 ...
	 * @var string
	 */
	public $via_table_name = "restaurant_foods";
	/**
	 * @var string
	 */
	public $via_table_relation = "restaurant_foods";
	/**
	 * @var string
	 */
	public $one_table_column = "restaurant_id";
	/**
	 * @var string
	 */
	public $two_table_column = "food_id";
	...
	private function linkData()
	{
        ...
        $elements = Food::find()->where(['IN', Food::primaryKey()[0], $data])->indexBy('id')->all();
        $data_sort = [];
