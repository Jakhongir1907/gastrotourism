...
/* @var $searchModel common\modules\restaurant\models\search\WaiterSearch */
            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <?= Html::a(Yii::t('app', 'Create Waiter'), ['create'],
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->position}</div>";
                            }
                        ],
                        [
