            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <?= Html::a(Yii::t('app', 'Create Food Versus'), ['create'],
            ...
            <div class="table-responsive card-body">
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'First food',
                            'contentOptions' => ['class' => 'v-align-middle'],
                            'format' => 'raw',
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->firstFood->name}</div>";
                            }
                        ],
                        [
                            'attribute' => 'Second food',
                            'contentOptions' => ['class' => 'v-align-middle'],
                            'format' => 'raw',
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->secondFood->name}</div>";
                            }
                        ],
                        [
                            'attribute' => 'First food likes',
                            'contentOptions' => ['class' => 'v-align-middle'],
                            'format' => 'raw',
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->first_likes}</div>";
                            }
                        ],
                        [
                            'attribute' => 'Second food likes',
                            'contentOptions' => ['class' => 'v-align-middle'],
                            'format' => 'raw',
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->second_likes}</div>";
                            }
                        ],
                        [
