...
use common\modules\restaurant\models\search\FoodVersusSearch;
use Yii;
 ...
 */
class FoodVersusController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new FoodVersusSearch();
    ...
    {
        if (($model = FoodVersus::findOne($id)) !== null) {
            return $model;
        }
