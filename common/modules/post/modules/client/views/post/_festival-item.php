...
<?php if ($index == 0): ?>
    ...
    <div class="main-card-text lola-text col-12 col-lg-7">
        <div class="card-theme"><h2><?=__("Ближающий Фестивали")?></h2></div>
        <div class="card-title"><?=$model->title?></div>
        <div class="card-data row">
            <div class="time col-6"><?=$model->getPrettyDate()?></div>
            <div class="count col-4"><img src="/images/eye.svg" alt="eye"> <span><?=$model->viewed?></span></div>
        </div>
        <div class="card-body">
            <p><?=$model->anons?></p>
        </div>
        ...
        <div class="absolute-img">
            <img src="/images/shar.png" alt="shar rasmi">
        </div>
    </div>
...
<?php else: ?>
    ...
    <div class="col-12 col-md-2">
        <div class="card-data row justify-content-between">
            ...
            <div class="count d-flex col-5 col-md-12 "><img src="/images/eye.svg" alt="eye"> <span><?=$model->viewed?></span></div>
        </div>
    </div>
