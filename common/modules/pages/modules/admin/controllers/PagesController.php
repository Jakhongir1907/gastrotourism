...
class PagesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->orderBy(['page_id' => SORT_DESC]);
...
//            return $this->redirect(['update', 'page_id' => $model->page_id]);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($page_id)
    {
