...
/* @var $searchModel common\modules\event\models\search\EventRegistrationSearch */
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model) {
                                return "<div style='width: 80%; white-space: pre-wrap;'>{$model->fullname}</div>";
                            }
                        ],
                        [
                            'attribute' => 'status',
                            ...
                            'contentOptions' => ['class' => 'v-align-middle'],
                            'value' => function ($model) {
                                return $model->status ? 'Active' : 'Non active';
                            }
                        ],
                        [
